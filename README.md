...
| 模型 | TNEWS | LCQMC | XNLI | INEWS | DRCD | CMRC2018 | CCKS18-3 | MSRANER | AVG | 参数量
| :----:| :----: | :----: | :----: |:----: |:----: |:----: |:----: |:----: |:----: |:----: |
| <a href="https://github.com/google-research/bert">BERT-base</a>	| 89.78 	| 86.9 	|77.8 | 82.7 | - | - | 92.53 | 95.38 | 84.30 | 108M |
| <a href="https://github.com/ymcui/Chinese-BERT-wwm">BERT-wwm-ext</a> |89.81   | ***87.3***  | 78.7	| 83.46 | - | - | 92.79 | 95.26 | 84.82  |108M |
...
| <a href="https://github.com/ymcui/Chinese-BERT-wwm">RoBERTa-wwm-large</a> |	***90.11*** |	86.82 | ***80.04*** | 82.78 | ***90.70/95.06*** | ***70.59/89.42*** | ***93.61*** | 95.32 |  84.94 | 330M |


注：TNEWS:文本分类；LCQMC:语义相似度；XNLI:自然语言推理；INEWS:情感分析；DRCD & CMRC2018:阅读理解；CCKS2018-3:智能客服问句匹配；

MSRANER:命名实体识别；cmrc2018仅开发集结果； 数据来源: https://github.com/chineseGLUE/chineseGLUE
