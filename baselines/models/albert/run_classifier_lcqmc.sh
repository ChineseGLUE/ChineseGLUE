...
# @Last Modified time: 2019-11-04 20:37:57
...
if [[ -d $GLUE_DIR ]]; then
  ...
  if [[ -d $TASK_NAME ]]; then
    ...
    echo "[ATTENTION] please download lcqmc dataset from https://github.com/pengming617/text_matching/tree/master/data"
    echo -e "put lcqmc dataset at $GLUE_DIR$TASK_NAME/:\n\t--train.txt\n\t--dev.txt\n\t--test.txt"
  fi
else
